...
const availabilitySchema = new mongoose.Schema(
  {
    ...
    slotType: {type: String,enum: ['available', 'booked', 'buffer', 'unavailable'],default: 'available'},
    status: {type: String,enum: ['upcoming', 'completed', 'no-show'],default: 'upcoming'},
    parentSlotId: {type: mongoose.Schema.Types.ObjectId,ref: 'Availability',default: null},
    ...
    // Manual/guest booking (entered directly by the tutor)
